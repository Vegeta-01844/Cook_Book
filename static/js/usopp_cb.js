...
const nextStepSound = new Audio('/static/audio/Extra/Whoosh.mp3');  // CHANGE HERE !!!!!!!!!!!!!!!!!!!!
nextStepSound.volume=0.3;
...
async function fetchData() {
    const response = await fetch('/static/data/recipes/usopp_cheese_balls.json');
