...
const nextStepSound = new Audio('/static/audio/Extra/Chopper_footsteps.m4a');  // CHANGE HERE !!!!!!!!!!!!!!!!!!!!
...
async function fetchData() {
    const response = await fetch('/static/data/recipes/chopper_paneer_tikka.json');
