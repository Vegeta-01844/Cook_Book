...
const nextStepSound = new Audio('/static/audio/Extra/Brook_Laugh.m4a');  // CHANGE HERE !!!!!!!!!!!!!!!!!!!!
nextStepSound.volume = 0.5;
...
async function fetchData() {
    const response = await fetch('/static/data/recipes/brook_cassata.json');
